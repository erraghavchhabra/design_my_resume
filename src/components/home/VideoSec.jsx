    ...
    >
      ...
      <div className="max-w-6xl bg-indigo-100 rounded-3xl w-full flex flex-col justify-between items-center  mx-auto ">
        ...
        <div className="flex flex-col lg:flex-row justify-between  w-full">
          ...
          >
           <iframe className="overflow-hidden rounded-2xl" width="100%" height="315" src="https://www.youtube.com/embed/OHz0xIR8uwI?si=ygUObAsqBqsKof8n" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
          </div>

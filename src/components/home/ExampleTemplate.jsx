...
const Exampletemplates = [
  {
    ...
    img: "/assets/img/r1.webp",
  },
  {
    id: 2,
    title: "College Resume",
    img: "/assets/img/r2.webp",
  },
  {
    id: 3,
    title: "Registered Nurse Resume",
    img: "/assets/img/r3.webp",
  },
  {
    id: 4,
    title: "Admin Resume",
    img: "/assets/img/r4.webp",
  },
];
    ...
    <div className="max-w-7xl w-full mx-auto px-6 py-12 sm:py-16 lg:py-20">
      ...
      <div className="max-w-3xl mx-auto text-center mb-12">
        ...
        <p className="text-lg text-gray-700">
          ...
          covering all types of jobs, industries and levels of experience. Every
          example has been reviewed and approved by a Certified Professional
          Resume Writer (CPRW).
        </p>
      </div>
